  ...
  <div id="app">
    <map-component /> 
      ...
      <div class="section__explore grid-container mb-8">
        <div class="house__card mb-3" v-for="direccion in rooms" :key="direccion['.key']">
          ...
          <div class="house__content bg-white p-3 border rounded">
            ...
            <div class="house__title font-bold mb-2">{{ direccion.item }}</div>
            <div class="house__price text-xs">
              <span class="font-bold">${{ direccion.item }} MXN</span> per night
            </div>
          </div>
        </div>
      </div>
